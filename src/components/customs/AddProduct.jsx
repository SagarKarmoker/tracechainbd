        ...
        <>
            <div className='flex justify-center'>
                <div className='flex flex-col gap-4'>
                    ...
                    <input type="text" className='p-2 border rounded-lg' placeholder='Enter Customs Address' value={customsAddr} onChange={(e) => setCustomsAddr(activeAccount?.address)} readOnly />
