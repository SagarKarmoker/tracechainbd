...
import { Box, Center, Divider, Input, Text, IconButton } from '@chakra-ui/react';
...
function TrackProduct() {
    ...
    return (
        <Box className='px-10 py-5 w-full min-h-screen bg-cover bg-center flex flex-col' style={{ backgroundImage: `url(${backgroundImage})` }}>
            ...
            <Text className='text-center mt-4'>Track the step-by-step dispatch history of a product</Text>
