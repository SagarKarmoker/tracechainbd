            ...
            const trackingList = events
                .map(event => {
                    ...
                    if (from === account && productId.toString() === pId && quantity > 0) {
                        // TODO: Fetch more details about the product (distributor details)
                        
                        // const productLifeCycle = await etherContract.getProductLifeCycle(productId);
                        // const _len = await etherContract.getDispatchLength(dispatchId);
                        // const d2r = await etherContract.dispatches(dispatchId);
    ...
    return (
        <>
            <div className='flex flex-col gap-4'>
                <h1 className='text-center text-4xl font-bold mb-4'>Track Product by Retailer</h1>
