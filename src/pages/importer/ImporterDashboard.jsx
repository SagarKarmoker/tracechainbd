                        ...
                        <div class="grid grid-cols-12 col-span-12 gap-6 xxl:col-span-9">
                            <div class="col-span-12 mt-8">
                                <div class="flex items-center h-10 intro-y">
                                    <h2 class="mr-5 text-lg font-medium truncate">Importer Dashboard</h2>
                                </div>
                                        ...
                                        <div class="p-5">
                                            <div class="flex justify-between">
                                                ...
                                                <div
                                                    ...
                                                    <span class="flex items-center">Till Now</span>
                                                </div>
                                            </div>
                                            <div class="ml-2 w-full flex-1">
                                                <div>
                                                    ...
                                                    <div class="mt-1 text-base text-gray-600">Prodcut Sales</div>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                        ...
                                        <div class="p-5">
                                            <div class="flex justify-between">
                                                ...
                                                <div
                                                    ...
                                                    <span class="flex items-center">Product Supplied</span>
                                                </div>
                                            </div>
                                            <div class="ml-2 w-full flex-1">
                                                <div>
                                                    <div class="mt-3 text-3xl font-bold leading-8">37</div>

                                                    <div class="mt-1 text-base text-gray-600">Distributors</div>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                        ...
                                        <div class="p-5">
                                            <div class="flex justify-between">
                                                ...
                                                <div
                                                    ...
                                                    <span class="flex items-center">Dispatched Retailer</span>
                                                </div>
                                            </div>
                                            <div class="ml-2 w-full flex-1">
                                                <div>
                                                    <div class="mt-3 text-3xl font-bold leading-8">25</div>

                                                    <div class="mt-1 text-base text-gray-600">Retailers</div>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                        ...
                                        <div class="p-5">
                                            <div class="flex justify-between">
                                                ...
                                                <div
                                                    ...
                                                    <span class="flex items-center">Dipatched Prodcuts</span>
                                                </div>
                                            </div>
                                            <div class="ml-2 w-full flex-1">
                                                <div>
                                                                ...
                                                                <tbody class="bg-white divide-y divide-gray-200">
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <p class="text-xs text-gray-400">Cosmetic Products
                                                                            </p>
                                                                        </td>
                                                                        <td
                                                                            class="px-6 py-4 whitespace-no-wrap text-sm leading-5">
